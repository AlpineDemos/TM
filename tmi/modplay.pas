...
type p4typ=array[0..63,0..3,1..4] of byte;
...
if PatternLine<>last then begin
 ...
 if patnum<>lastpatnum then begin
   WriteFlat(Pattern[Arrangement[patnum]],APat,1024);
   lastpatnum:=patnum;
 end;
...
{ writexy(14,21,strg0(ticks,2),7,q);}
 ...
 For inst:=0 to 3 do begin
  Writexy(18+inst*15+7,42,D2H(longint(MInstSmp[inst]),8),15,q);
  Writexy(18+inst*15+7,43,D2H(longint(MInstPos[inst]),8),15,q);
  Writexy(18+inst*15+7,44,D2H(longint(MInstInc[inst]),8),15,q);
  Writexy(17+inst*15+7,45,D2H(longint(MInstLen[inst] shr 16),4),15,q);
  Writexy(24+inst*15+7,45,D2H(longint(MInstVol[inst]),2),15,q);
  Writexy(17+inst*15+7,46,D2H(longint(MInstLoopS[inst] shr 16),4),15,q);

{ Writexy(17+inst*15+7,45,D2H(longint(MInstVol [inst]),8),5,q);
  Writexy(17+inst*15+7,46,D2H(longint(MInstEff1[inst]),8),5,q);
  Writexy(17+inst*15+7,47,D2H(longint(MInstEff2[inst]),8),5,q);
  Writexy(17+inst*15+7,48,D2H(longint(MInstEff3[inst]),8),5,q);}
