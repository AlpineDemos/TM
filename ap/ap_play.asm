...
;ДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДД;
 ...
 Effect db  00,07h, 00,07h   ; 0 = Nothing
        ...
        db  32,0Ah,'ч',0Ah   ; 9 = Fine Vibrato
        db  32,09h, 22,09h   ;10 = Tremor
        db  32,0Ah,'р',0Ah   ;11 = Arpeggio
 ...
 ;ЫІ±° Tracking-Window °±ІЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫ
